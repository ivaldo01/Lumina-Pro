...
- [x] Revisar as permissões concedidas aos aplicativos mantidos.
...
- [x] Ativar autenticação em dois fatores para proprietário e equipe.
- [x] Revisar contas de equipe e acessos de colaboradores.
